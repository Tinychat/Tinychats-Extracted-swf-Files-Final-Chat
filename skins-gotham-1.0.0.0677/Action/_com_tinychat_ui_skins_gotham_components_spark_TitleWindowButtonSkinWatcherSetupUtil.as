package 
{
    ...
    public class _com_tinychat_ui_skins_gotham_components_spark_TitleWindowButtonSkinWatcherSetupUtil extends Object implements IWatcherSetupUtil2
    {

        public function _com_tinychat_ui_skins_gotham_components_spark_TitleWindowButtonSkinWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            TitleWindowButtonSkin.watcherSetupUtil = new _com_tinychat_ui_skins_gotham_components_spark_TitleWindowButtonSkinWatcherSetupUtil;
            return;
        }// end function
