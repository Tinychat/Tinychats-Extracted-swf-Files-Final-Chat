package 
{
    ...
    public class _com_tinychat_ui_skins_gotham_components_social_buttonbar_SocialButtonBarButtonSkinWatcherSetupUtil extends Object implements IWatcherSetupUtil2
    {

        public function _com_tinychat_ui_skins_gotham_components_social_buttonbar_SocialButtonBarButtonSkinWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            SocialButtonBarButtonSkin.watcherSetupUtil = new _com_tinychat_ui_skins_gotham_components_social_buttonbar_SocialButtonBarButtonSkinWatcherSetupUtil;
            return;
        }// end function
