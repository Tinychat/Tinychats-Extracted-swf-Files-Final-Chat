package 
{
    ...
    public class _com_tinychat_ui_skins_gotham_components_trial_UpgradeButtonSkinWatcherSetupUtil extends Object implements IWatcherSetupUtil2
    {

        public function _com_tinychat_ui_skins_gotham_components_trial_UpgradeButtonSkinWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            UpgradeButtonSkin.watcherSetupUtil = new _com_tinychat_ui_skins_gotham_components_trial_UpgradeButtonSkinWatcherSetupUtil;
            return;
        }// end function
