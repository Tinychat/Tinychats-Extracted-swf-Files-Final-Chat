package 
{
    ...
    public class _com_tinychat_ui_skins_gotham_components_social_buttonbar_UsersListButtonBarButtonSkinWatcherSetupUtil extends Object implements IWatcherSetupUtil2
    {

        public function _com_tinychat_ui_skins_gotham_components_social_buttonbar_UsersListButtonBarButtonSkinWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            UsersListButtonBarButtonSkin.watcherSetupUtil = new _com_tinychat_ui_skins_gotham_components_social_buttonbar_UsersListButtonBarButtonSkinWatcherSetupUtil;
            return;
        }// end function
