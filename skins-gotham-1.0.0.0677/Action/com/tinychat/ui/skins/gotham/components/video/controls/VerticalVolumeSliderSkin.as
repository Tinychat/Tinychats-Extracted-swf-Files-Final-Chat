package com.tinychat.ui.skins.gotham.components.video.controls
{
    ...
    public class VerticalVolumeSliderSkin extends Skin implements IStateClient2
    {
        ...
        public function VerticalVolumeSliderSkin()
        {
            mx_internal::_document = this;
            this.minWidth = 9;
            this.mxmlContent = [this._VerticalVolumeSliderSkin_Button1_i(), this._VerticalVolumeSliderSkin_Button2_i()];
        ...
        {
            var _loc_1:* = this.thumb.getLayoutBoundsY();
            this.thumb.setLayoutBoundsPosition(this.thumb.getLayoutBoundsX(), 0);
            super.measure();
            this.thumb.setLayoutBoundsPosition(this.thumb.getLayoutBoundsX(), _loc_1);
            return;
        }// end function

        private function _VerticalVolumeSliderSkin_Button1_i() : Button
        {
        ...
        private function _VerticalVolumeSliderSkin_Button2_i() : Button
        {
            var _loc_1:* = new Button();
            _loc_1.left = 0;
            _loc_1.right = 0;
