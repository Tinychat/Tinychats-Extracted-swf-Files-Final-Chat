package com.tinychat.ui.skins.gotham.components.login.tumblr
{
    ...
    public class TumblrButtonSkin extends SparkSkin implements IStateClient2
    {
        ...
        private var _embed_mxml__images_tumblr_login_png_1782941894:Class;
        private var _213507019hostComponent:Button;

        public function TumblrButtonSkin()
        {
            this._embed_mxml__images_tumblr_login_png_1782941894 = TumblrButtonSkin__embed_mxml__images_tumblr_login_png_1782941894;
            mx_internal::_document = this;
            this.minWidth = 21;
            this.minHeight = 21;
            this.mxmlContent = [this._TumblrButtonSkin_Rect1_c(), this._TumblrButtonSkin_Rect2_c(), this._TumblrButtonSkin_Rect3_c(), this._TumblrButtonSkin_BitmapImage1_c()];
            this.currentState = "up";
            this.addEventListener("creationComplete", this.___TumblrButtonSkin_SparkSkin1_creationComplete);
        ...
        private function _TumblrButtonSkin_Rect1_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 1;
            _loc_1.right = 1;
            _loc_1.top = 1;
            _loc_1.bottom = 1;
            _loc_1.fill = this._TumblrButtonSkin_LinearGradient1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _TumblrButtonSkin_LinearGradient1_c() : LinearGradient
        {
            var _loc_1:* = new LinearGradient();
            _loc_1.rotation = 90;
            _loc_1.entries = [this._TumblrButtonSkin_GradientEntry1_i(), this._TumblrButtonSkin_GradientEntry2_i()];
            return _loc_1;
        }// end function

        private function _TumblrButtonSkin_GradientEntry1_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 6457249;
            this.ge1 = _loc_1;
            BindingManager.executeBindings(this, "ge1", this.ge1);
            return _loc_1;
        }// end function

        private function _TumblrButtonSkin_GradientEntry2_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 3562356;
            this.ge2 = _loc_1;
            BindingManager.executeBindings(this, "ge2", this.ge2);
            return _loc_1;
        }// end function

        private function _TumblrButtonSkin_Rect2_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 1;
            _loc_1.right = 1;
            ...
            _loc_1.bottom = 1;
            _loc_1.radiusX = 2;
            _loc_1.stroke = this._TumblrButtonSkin_LinearGradientStroke1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _TumblrButtonSkin_LinearGradientStroke1_c() : LinearGradientStroke
        {
            var _loc_1:* = new LinearGradientStroke();
            _loc_1.weight = 1;
            _loc_1.rotation = 90;
            _loc_1.entries = [this._TumblrButtonSkin_GradientEntry3_i(), this._TumblrButtonSkin_GradientEntry4_i(), this._TumblrButtonSkin_GradientEntry5_i()];
            return _loc_1;
        }// end function

        private function _TumblrButtonSkin_GradientEntry3_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 8692150;
            _loc_1.ratio = 0;
            this.ge3 = _loc_1;
        ...
        private function _TumblrButtonSkin_GradientEntry4_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 6457249;
            _loc_1.ratio = 0.1;
        ...
        private function _TumblrButtonSkin_GradientEntry5_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 3562356;
            _loc_1.ratio = 1;
        ...
        private function _TumblrButtonSkin_Rect3_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 0;
            _loc_1.right = 0;
            ...
            _loc_1.bottom = 0;
            _loc_1.radiusX = 2;
            _loc_1.stroke = this._TumblrButtonSkin_SolidColorStroke1_i();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _TumblrButtonSkin_SolidColorStroke1_i() : SolidColorStroke
        {
        ...
        private function _TumblrButtonSkin_BitmapImage1_c() : BitmapImage
        {
            var _loc_1:* = new BitmapImage();
            _loc_1.source = this._embed_mxml__images_tumblr_login_png_1782941894;
            _loc_1.left = 10;
        ...
        public function ___TumblrButtonSkin_SparkSkin1_creationComplete(event:FlexEvent) : void
        {
            this.showHandCursor();
            return;
        }// end function
