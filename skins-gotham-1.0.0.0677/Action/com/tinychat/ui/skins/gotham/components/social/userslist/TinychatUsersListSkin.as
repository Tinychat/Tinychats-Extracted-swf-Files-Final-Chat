package com.tinychat.ui.skins.gotham.components.social.userslist
{
    ...
    public class TinychatUsersListSkin extends Skin implements IStateClient2
    {
        ...
        public function TinychatUsersListSkin()
        {
            mx_internal::_document = this;
            this.minWidth = 112;
            this.mxmlContent = [this._TinychatUsersListSkin_Scroller1_c(), this._TinychatUsersListSkin_TinychatUserPopupMenu1_i()];
        ...
        private function _TinychatUsersListSkin_Scroller1_c() : Scroller
        {
            ...
            _loc_1.viewport = this._TinychatUsersListSkin_DataGroup1_i();
        ...
        private function _TinychatUsersListSkin_DataGroup1_i() : DataGroup
        {
            var _loc_1:* = new DataGroup();
            _loc_1.itemRenderer = this._TinychatUsersListSkin_ClassFactory1_c();
            _loc_1.layout = this._TinychatUsersListSkin_VerticalLayout1_c();
            _loc_1.id = "dataGroup";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
        ...
        private function _TinychatUsersListSkin_ClassFactory1_c() : ClassFactory
        {
            var _loc_1:* = new ClassFactory();
            _loc_1.generator = TinychatUsersListItemRenderer;
            return _loc_1;
        }// end function

        private function _TinychatUsersListSkin_VerticalLayout1_c() : VerticalLayout
        {
        ...
        private function _TinychatUsersListSkin_TinychatUserPopupMenu1_i() : TinychatUserPopupMenu
        {
