package com.tinychat.ui.skins.gotham.components.spark
{
    ...
    public class ScrollBarUpButtonSkin extends Skin implements IStateClient2
    {
        ...
        public function ScrollBarUpButtonSkin()
        {
            ...
            this.mxmlContent = [this._ScrollBarUpButtonSkin_Rect1_c(), this._ScrollBarUpButtonSkin_Path1_c()];
            this.currentState = "up";
            states = [new State({name:"up", overrides:[]}), new State({name:"over", overrides:[new SetProperty().initializeFromObject({target:"_ScrollBarUpButtonSkin_SolidColor2", name:"color", value:9671571})]}), new State({name:"down", overrides:[]}), new State({name:"disabled", overrides:[]})];
            return;
        }// end function
        ...
        private function _ScrollBarUpButtonSkin_Rect1_c() : Rect
        {
            ...
            _loc_1.top = 0;
            _loc_1.bottom = 0;
            _loc_1.fill = this._ScrollBarUpButtonSkin_SolidColor1_c();
        ...
        {
            var _loc_1:* = new Path();
            _loc_1.data = "M 0 3 L 2.5 0 L 5 3 L 0 3";
            _loc_1.horizontalCenter = 0;
            _loc_1.verticalCenter = 0;
            _loc_1.fill = this._ScrollBarUpButtonSkin_SolidColor2_i();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function
        ...
        private function _ScrollBarUpButtonSkin_SolidColor2_i() : SolidColor
        {
            ...
            this._ScrollBarUpButtonSkin_SolidColor2 = _loc_1;
        ...
        {
            var _loc_2:* = this._454127828_ScrollBarUpButtonSkin_SolidColor2;
            if (_loc_2 !== param1)
            {
                this._454127828_ScrollBarUpButtonSkin_SolidColor2 = param1;
                if (this.hasEventListener("propertyChange"))
                {
                    this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "_ScrollBarUpButtonSkin_SolidColor2", _loc_2, param1));
                }
            }
            return;
        }// end function
