package com.tinychat.ui.skins.gotham.components.spark
{
    ...
    public class VScrollBarThumbSkin extends Skin implements IBindingClient, IStateClient2
    {
        public var _VScrollBarThumbSkin_AnimateColor1:AnimateColor;
        ...
        public function VScrollBarThumbSkin()
        {
            ...
            bindings = this._VScrollBarThumbSkin_bindingsSetup();
            var watchers:Array;
            target;
            if (_watcherSetupUtil == null)
            {
                watcherSetupUtilClass = getDefinitionByName("_com_tinychat_ui_skins_gotham_components_spark_VScrollBarThumbSkinWatcherSetupUtil");
            ...
            {
                return VScrollBarThumbSkin[param1];
            }// end function
            , bindings, watchers);
            mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
            mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
            this.transitions = [this._VScrollBarThumbSkin_Transition1_c()];
            this.mxmlContent = [this._VScrollBarThumbSkin_Rect1_c(), this._VScrollBarThumbSkin_Line1_c()];
        ...
        private function _VScrollBarThumbSkin_Transition1_c() : Transition
        {
            var _loc_1:* = new Transition();
            _loc_1.autoReverse = true;
            _loc_1.effect = this._VScrollBarThumbSkin_AnimateColor1_i();
            return _loc_1;
        }// end function

        private function _VScrollBarThumbSkin_AnimateColor1_i() : AnimateColor
        {
            var _loc_1:* = new AnimateColor();
            _loc_1.duration = 250;
            this._VScrollBarThumbSkin_AnimateColor1 = _loc_1;
            BindingManager.executeBindings(this, "_VScrollBarThumbSkin_AnimateColor1", this._VScrollBarThumbSkin_AnimateColor1);
            return _loc_1;
        }// end function
        ...
        private function _VScrollBarThumbSkin_Rect1_c() : Rect
        {
            ...
            _loc_1.bottom = 0;
            _loc_1.radiusX = 2;
            _loc_1.fill = this._VScrollBarThumbSkin_LinearGradient1_c();
            _loc_1.stroke = this._VScrollBarThumbSkin_SolidColorStroke1_c();
        ...
        private function _VScrollBarThumbSkin_LinearGradient1_c() : LinearGradient
        {
            ...
            _loc_1.entries = [this._VScrollBarThumbSkin_GradientEntry1_i(), this._VScrollBarThumbSkin_GradientEntry2_i(), this._VScrollBarThumbSkin_GradientEntry3_i(), this._VScrollBarThumbSkin_GradientEntry4_i()];
            return _loc_1;
        }// end function
        ...
        private function _VScrollBarThumbSkin_Line1_c() : Line
        {
            var _loc_1:* = new Line();
            _loc_1.top = 0;
            _loc_1.bottom = 0;
            _loc_1.horizontalCenter = 0;
            _loc_1.stroke = this._VScrollBarThumbSkin_SolidColorStroke2_i();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _VScrollBarThumbSkin_SolidColorStroke2_i() : SolidColorStroke
        {
            var _loc_1:* = new SolidColorStroke();
        ...
        private function _VScrollBarThumbSkin_bindingsSetup() : Array
        {
            var result:Array;
            ...
            , null, "_VScrollBarThumbSkin_AnimateColor1.targets");
            return result;
        }// end function
        ...
        {
            VScrollBarThumbSkin._watcherSetupUtil = param1;
            return;
        }// end function
