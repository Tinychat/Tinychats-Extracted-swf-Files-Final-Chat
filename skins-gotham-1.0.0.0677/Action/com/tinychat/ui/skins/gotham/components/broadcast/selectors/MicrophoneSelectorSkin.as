package com.tinychat.ui.skins.gotham.components.broadcast.selectors
{
    ...
    public class MicrophoneSelectorSkin extends Skin implements IStateClient2
    {
        public var _MicrophoneSelectorSkin_AjaxLoader1:AjaxLoader;
        ...
        private var _213507019hostComponent:MicrophoneSelector;

        public function MicrophoneSelectorSkin()
        {
            mx_internal::_document = this;
            this.mxmlContent = [this._MicrophoneSelectorSkin_Scroller1_i()];
            this.currentState = "disabled";
            this._MicrophoneSelectorSkin_ClassFactory2_i();
            this._MicrophoneSelectorSkin_ClassFactory1_i();
            var _loc_1:* = new DeferredInstanceFromFunction(this._MicrophoneSelectorSkin_AjaxLoader1_i);
        ...
        private function _MicrophoneSelectorSkin_ClassFactory2_i() : ClassFactory
        {
            var _loc_1:* = new ClassFactory();
            _loc_1.generator = MicrophoneSelectorSkinInnerClass1;
        ...
        private function _MicrophoneSelectorSkin_ClassFactory1_i() : ClassFactory
        {
            var _loc_1:* = new ClassFactory();
            _loc_1.generator = MicrophoneSelectorSkinInnerClass0;
            _loc_1.properties = {outerDocument:this};
        ...
        private function _MicrophoneSelectorSkin_AjaxLoader1_i() : AjaxLoader
        {
            var _loc_1:* = new AjaxLoader();
            _loc_1.horizontalCenter = 0;
            _loc_1.verticalCenter = 10;
            _loc_1.id = "_MicrophoneSelectorSkin_AjaxLoader1";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
            }
            this._MicrophoneSelectorSkin_AjaxLoader1 = _loc_1;
            BindingManager.executeBindings(this, "_MicrophoneSelectorSkin_AjaxLoader1", this._MicrophoneSelectorSkin_AjaxLoader1);
            return _loc_1;
        }// end function

        private function _MicrophoneSelectorSkin_Scroller1_i() : Scroller
        {
            ...
            _loc_1.viewport = this._MicrophoneSelectorSkin_DataGroup1_i();
        ...
        private function _MicrophoneSelectorSkin_DataGroup1_i() : DataGroup
        {
            var _loc_1:* = new DataGroup();
            _loc_1.layout = this._MicrophoneSelectorSkin_TileLayout1_c();
            _loc_1.id = "dataGroup";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
        ...
        private function _MicrophoneSelectorSkin_TileLayout1_c() : TileLayout
        {
            var _loc_1:* = new TileLayout();
            _loc_1.requestedColumnCount = 3;
            _loc_1.columnWidth = 125;
            _loc_1.rowHeight = 61;
            _loc_1.horizontalGap = 20;
            _loc_1.verticalGap = 20;
            return _loc_1;
        }// end function
        ...
        public function get hostComponent() : MicrophoneSelector
        {
            return this._213507019hostComponent;
        }// end function

        public function set hostComponent(param1:MicrophoneSelector) : void
        {
