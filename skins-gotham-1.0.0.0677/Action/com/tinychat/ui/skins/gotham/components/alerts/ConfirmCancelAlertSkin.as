package com.tinychat.ui.skins.gotham.components.alerts
{
    ...
    public class ConfirmCancelAlertSkin extends Skin
    {
        ...
        public function ConfirmCancelAlertSkin()
        {
            mx_internal::_document = this;
            this.width = 400;
            this.layout = this._ConfirmCancelAlertSkin_VerticalLayout1_c();
            this.mxmlContent = [this._ConfirmCancelAlertSkin_TitleDisplay1_i(), this._ConfirmCancelAlertSkin_Label1_i(), this._ConfirmCancelAlertSkin_HGroup1_c()];
            return;
        }// end function
        ...
        private function _ConfirmCancelAlertSkin_VerticalLayout1_c() : VerticalLayout
        {
        ...
        private function _ConfirmCancelAlertSkin_TitleDisplay1_i() : TitleDisplay
        {
        ...
        private function _ConfirmCancelAlertSkin_Label1_i() : Label
        {
        ...
        private function _ConfirmCancelAlertSkin_HGroup1_c() : HGroup
        {
            var _loc_1:* = new HGroup();
            _loc_1.gap = 20;
            _loc_1.columnWidth = 100;
            _loc_1.variableColumnWidth = false;
            _loc_1.mxmlContent = [this._ConfirmCancelAlertSkin_Button1_i(), this._ConfirmCancelAlertSkin_Button2_i()];
            if (!_loc_1.document)
            {
                _loc_1.document = this;
            }
        ...
        private function _ConfirmCancelAlertSkin_Button1_i() : Button
        {
        ...
        private function _ConfirmCancelAlertSkin_Button2_i() : Button
        {
            var _loc_1:* = new Button();
            _loc_1.id = "confirm";
            if (!_loc_1.document)
