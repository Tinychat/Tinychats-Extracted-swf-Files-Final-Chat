package com.tinychat.ui.skins.gotham.components.login.facebook
{
    ...
    public class FacebookButtonSkin extends SparkSkin implements IStateClient2
    {
        ...
        private var _embed_mxml__images_facebook_login_png_96820422:Class;
        private var _213507019hostComponent:Button;

        public function FacebookButtonSkin()
        {
            this._embed_mxml__images_facebook_login_png_96820422 = FacebookButtonSkin__embed_mxml__images_facebook_login_png_96820422;
            mx_internal::_document = this;
            this.minWidth = 21;
            this.minHeight = 21;
            this.mxmlContent = [this._FacebookButtonSkin_Rect1_c(), this._FacebookButtonSkin_Rect2_c(), this._FacebookButtonSkin_Rect3_c(), this._FacebookButtonSkin_BitmapImage1_c()];
            this.currentState = "up";
            this.addEventListener("creationComplete", this.___FacebookButtonSkin_SparkSkin1_creationComplete);
        ...
        private function _FacebookButtonSkin_Rect1_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 1;
            _loc_1.right = 1;
            _loc_1.top = 1;
            _loc_1.bottom = 1;
            _loc_1.fill = this._FacebookButtonSkin_LinearGradient1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _FacebookButtonSkin_LinearGradient1_c() : LinearGradient
        {
            var _loc_1:* = new LinearGradient();
            _loc_1.rotation = 90;
            _loc_1.entries = [this._FacebookButtonSkin_GradientEntry1_i(), this._FacebookButtonSkin_GradientEntry2_i()];
            return _loc_1;
        }// end function

        private function _FacebookButtonSkin_GradientEntry1_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 7506875;
            this.ge1 = _loc_1;
            BindingManager.executeBindings(this, "ge1", this.ge1);
            return _loc_1;
        }// end function

        private function _FacebookButtonSkin_GradientEntry2_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 4480397;
            this.ge2 = _loc_1;
            BindingManager.executeBindings(this, "ge2", this.ge2);
            return _loc_1;
        }// end function

        private function _FacebookButtonSkin_Rect2_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 1;
            _loc_1.right = 1;
            ...
            _loc_1.bottom = 1;
            _loc_1.radiusX = 2;
            _loc_1.stroke = this._FacebookButtonSkin_LinearGradientStroke1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _FacebookButtonSkin_LinearGradientStroke1_c() : LinearGradientStroke
        {
            var _loc_1:* = new LinearGradientStroke();
            _loc_1.weight = 1;
            _loc_1.rotation = 90;
            _loc_1.entries = [this._FacebookButtonSkin_GradientEntry3_i(), this._FacebookButtonSkin_GradientEntry4_i(), this._FacebookButtonSkin_GradientEntry5_i()];
            return _loc_1;
        }// end function

        private function _FacebookButtonSkin_GradientEntry3_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 9413577;
            _loc_1.ratio = 0;
            this.ge3 = _loc_1;
        ...
        private function _FacebookButtonSkin_GradientEntry4_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 7506875;
            _loc_1.ratio = 0.1;
        ...
        private function _FacebookButtonSkin_GradientEntry5_i() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
            _loc_1.color = 4480397;
            _loc_1.ratio = 1;
        ...
        private function _FacebookButtonSkin_Rect3_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 0;
            _loc_1.right = 0;
            ...
            _loc_1.bottom = 0;
            _loc_1.radiusX = 2;
            _loc_1.stroke = this._FacebookButtonSkin_SolidColorStroke1_i();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _FacebookButtonSkin_SolidColorStroke1_i() : SolidColorStroke
        {
        ...
        private function _FacebookButtonSkin_BitmapImage1_c() : BitmapImage
        {
            var _loc_1:* = new BitmapImage();
            _loc_1.source = this._embed_mxml__images_facebook_login_png_96820422;
            _loc_1.left = 10;
        ...
        public function ___FacebookButtonSkin_SparkSkin1_creationComplete(event:FlexEvent) : void
        {
            this.showHandCursor();
            return;
        }// end function
