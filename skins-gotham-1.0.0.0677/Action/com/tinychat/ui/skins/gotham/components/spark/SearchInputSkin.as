package com.tinychat.ui.skins.gotham.components.spark
{
    ...
    public class SearchInputSkin extends Skin implements IStateClient2
    {
        ...
        public function SearchInputSkin()
        {
            mx_internal::_document = this;
            this.mxmlContent = [this._SearchInputSkin_Rect1_c(), this._SearchInputSkin_Rect2_c(), this._SearchInputSkin_Rect3_c(), this._SearchInputSkin_RichEditableText1_i(), this._SearchInputSkin_RichEditableText2_i(), this._SearchInputSkin_SearchIcon1_c()];
        ...
        private function _SearchInputSkin_Rect1_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 0;
            _loc_1.right = 0;
            ...
            _loc_1.bottom = 0;
            _loc_1.radiusX = 2;
            _loc_1.stroke = this._SearchInputSkin_SolidColorStroke1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _SearchInputSkin_SolidColorStroke1_c() : SolidColorStroke
        {
        ...
        private function _SearchInputSkin_Rect2_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 1;
            _loc_1.right = 1;
            ...
            _loc_1.bottom = 1;
            _loc_1.radiusX = 2;
            _loc_1.stroke = this._SearchInputSkin_SolidColorStroke2_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _SearchInputSkin_SolidColorStroke2_c() : SolidColorStroke
        {
            var _loc_1:* = new SolidColorStroke();
        ...
        private function _SearchInputSkin_Rect3_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 1;
            _loc_1.right = 1;
            ...
            _loc_1.bottom = 1;
            _loc_1.radiusX = 2;
            _loc_1.fill = this._SearchInputSkin_SolidColor1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _SearchInputSkin_SolidColor1_c() : SolidColor
        {
        ...
        private function _SearchInputSkin_RichEditableText1_i() : RichEditableText
        {
        ...
        private function _SearchInputSkin_RichEditableText2_i() : RichEditableText
        {
            var _loc_1:* = new RichEditableText();
            _loc_1.left = 10;
            _loc_1.right = 30;
        ...
        private function _SearchInputSkin_SearchIcon1_c() : SearchIcon
        {
            var _loc_1:* = new SearchIcon();
            _loc_1.right = 10;
