package com.tinychat.ui.skins.gotham.components.spark
{
    ...
    public class HScrollBarTrackSkin extends Skin implements IStateClient2
    {
        ...
        public function HScrollBarTrackSkin()
        {
            ...
            this.mxmlContent = [this._HScrollBarTrackSkin_Rect1_c()];
        ...
        private function _HScrollBarTrackSkin_Rect1_c() : Rect
        {
            ...
            _loc_1.left = 0;
            _loc_1.right = 0;
            _loc_1.fill = this._HScrollBarTrackSkin_SolidColor1_c();
