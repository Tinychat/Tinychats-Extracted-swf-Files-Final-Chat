package com.tinychat.ui.skins.gotham.components.youtube
{
    ...
    public class YouTubeLoopButtonSkin extends SparkButtonSkin implements IStateClient2
    {
        private var _1919293257iconDisplay2:BitmapImage;
        private var __moduleFactoryInitialized:Boolean = false;
        private var _embed_mxml__images_icons_playlist_loop_png_1517993001:Class;

        public function YouTubeLoopButtonSkin()
        {
            this._embed_mxml__images_icons_playlist_loop_png_1517993001 = YouTubeLoopButtonSkin__embed_mxml__images_icons_playlist_loop_png_1517993001;
            mx_internal::_document = this;
            this.minWidth = 20;
            this.minHeight = 20;
            this.mxmlContent = [this._YouTubeLoopButtonSkin_Rect1_c(), this._YouTubeLoopButtonSkin_BitmapImage1_i()];
        ...
        private function _YouTubeLoopButtonSkin_Rect1_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 0;
            _loc_1.right = 0;
            _loc_1.top = 0;
            _loc_1.bottom = 0;
            _loc_1.fill = this._YouTubeLoopButtonSkin_SolidColor1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _YouTubeLoopButtonSkin_SolidColor1_c() : SolidColor
        {
        ...
        private function _YouTubeLoopButtonSkin_BitmapImage1_i() : BitmapImage
        {
            var _loc_1:* = new BitmapImage();
            _loc_1.width = 24;
            _loc_1.height = 20;
            _loc_1.alpha = 0.5;
            _loc_1.source = this._embed_mxml__images_icons_playlist_loop_png_1517993001;
