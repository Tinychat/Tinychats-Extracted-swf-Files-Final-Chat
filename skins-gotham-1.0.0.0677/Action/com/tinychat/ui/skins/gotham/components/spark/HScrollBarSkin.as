package com.tinychat.ui.skins.gotham.components.spark
{
    ...
    public class HScrollBarSkin extends Skin implements IStateClient2
    {
        ...
        public function HScrollBarSkin()
        {
            ...
            this.minWidth = 35;
            this.minHeight = 11;
            this.mxmlContent = [this._HScrollBarSkin_Rect1_c(), this._HScrollBarSkin_Rect2_c(), this._HScrollBarSkin_Button1_i(), this._HScrollBarSkin_Button2_i(), this._HScrollBarSkin_Button3_i(), this._HScrollBarSkin_Button4_i()];
        ...
        private function _HScrollBarSkin_Rect1_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 0;
            _loc_1.right = 0;
            _loc_1.top = 0;
            _loc_1.bottom = 0;
            _loc_1.stroke = this._HScrollBarSkin_SolidColorStroke1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _HScrollBarSkin_SolidColorStroke1_c() : SolidColorStroke
        {
        ...
        private function _HScrollBarSkin_Rect2_c() : Rect
        {
            var _loc_1:* = new Rect();
            _loc_1.left = 1;
            _loc_1.right = 1;
            _loc_1.top = 1;
            _loc_1.bottom = 1;
            _loc_1.fill = this._HScrollBarSkin_LinearGradient1_c();
            _loc_1.initialized(this, null);
            return _loc_1;
        }// end function

        private function _HScrollBarSkin_LinearGradient1_c() : LinearGradient
        {
            var _loc_1:* = new LinearGradient();
            _loc_1.entries = [this._HScrollBarSkin_GradientEntry1_c(), this._HScrollBarSkin_GradientEntry2_c()];
            return _loc_1;
        }// end function

        private function _HScrollBarSkin_GradientEntry1_c() : GradientEntry
        {
        ...
        private function _HScrollBarSkin_GradientEntry2_c() : GradientEntry
        {
            var _loc_1:* = new GradientEntry();
        ...
        private function _HScrollBarSkin_Button2_i() : Button
        {
            ...
            _loc_1.width = 54;
            _loc_1.focusEnabled = false;
            _loc_1.setStyle("skinClass", HScrollBarTrackSkin);
            _loc_1.id = "track";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
        ...
        private function _HScrollBarSkin_Button3_i() : Button
        {
            ...
            _loc_1.minHeight = 7;
            _loc_1.focusEnabled = false;
            _loc_1.setStyle("skinClass", HScrollBarThumbSkin);
            _loc_1.id = "thumb";
            if (!_loc_1.document)
            {
                _loc_1.document = this;
