package 
{
    ...
    public class _com_tinychat_ui_skins_gotham_components_spark_VScrollBarThumbSkinWatcherSetupUtil extends Object implements IWatcherSetupUtil2
    {

        public function _com_tinychat_ui_skins_gotham_components_spark_VScrollBarThumbSkinWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            VScrollBarThumbSkin.watcherSetupUtil = new _com_tinychat_ui_skins_gotham_components_spark_VScrollBarThumbSkinWatcherSetupUtil;
            return;
        }// end function
