package 
{
    ...
    public class _com_tinychat_ui_skins_gotham_components_social_buttonbar_MessageCountDisplayButtonBarButtonSkinWatcherSetupUtil extends Object implements IWatcherSetupUtil2
    {

        public function _com_tinychat_ui_skins_gotham_components_social_buttonbar_MessageCountDisplayButtonBarButtonSkinWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        {
            MessageCountDisplayButtonBarButtonSkin.watcherSetupUtil = new _com_tinychat_ui_skins_gotham_components_social_buttonbar_MessageCountDisplayButtonBarButtonSkinWatcherSetupUtil;
            return;
        }// end function
