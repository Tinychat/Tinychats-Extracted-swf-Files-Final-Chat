package com.facebook.graph.net
{
    ...
    public class FacebookBatchRequest extends AbstractFacebookRequest
    {
        ...
        public function call(accessToken:String) : void
        {
            ...
            while (_loc_7 < _loc_6)
            {
                ...
                if (_loc_8.params)
                {
                    ...
                    if (_loc_8.requestMethod != URLRequestMethod.GET)
                    {
                    }
                    if (_loc_8.requestMethod.toUpperCase() == "DELETE")
                    {
            ...
            if (!_loc_4)
            {
                ...
                _loc_12.access_token = accessToken;
        ...
        protected function sendPostRequest(requests:Array, files:Array) : void
        {
            ...
            _loc_3.writePostData("batch", JSON.encode(requests));
            var _loc_4:* = requests.length;
            var _loc_5:uint = 0;
            while (_loc_5 < _loc_4)
            {
                
                _loc_6 = requests[_loc_5];
                _loc_7 = files[_loc_5];
                if (_loc_7)
                {
                    if (_loc_7 is Bitmap)
