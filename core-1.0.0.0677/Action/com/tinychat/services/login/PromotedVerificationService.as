package com.tinychat.services.login
{
    ...
    public class PromotedVerificationService extends AbstractUrlLoaderService
    {
        private var _success:Signal;

        public function PromotedVerificationService()
        {
            super("https://tinychat.com/api/promoted.php");
