package com.tinychat.controller.commands.broadcast.media.notifications
{
    ...
    public class PauseMediaNotification extends AbstractMediaNotification
    {

        public function PauseMediaNotification(param1:MediaType)
        {
            var _loc_2:String = "paused the {0}.";
