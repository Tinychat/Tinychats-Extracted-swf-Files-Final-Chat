package com.tinychat.controller.commands.broadcast.media.notifications
{
    ...
    public class PlayMediaNotification extends AbstractMediaNotification
    {

        public function PlayMediaNotification(param1:MediaType)
        {
            var _loc_2:String = "unpaused the {0}.";
