package com.tinychat.model.validation
{
    ...
    public class IsntPromotedBroadcast extends IsBroadcaster
    {
        private var canvas:RoomBroadcastCanvas;

        public function IsntPromotedBroadcast(param1:RoomBroadcastCanvasBroadcasts, param2:RoomBroadcastCanvas)
        {
            super(param1);
            this.canvas = param2;
            return;
