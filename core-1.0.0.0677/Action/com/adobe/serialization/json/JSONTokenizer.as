package com.adobe.serialization.json
{
    ...
    public class JSONTokenizer extends Object
    {
        ...
        public function unescapeString(input:String) : String
        {
            ...
            if (this.controlCharsRegExp.test(input))
            {
            ...
            var _loc_3:int = 0;
            var _loc_4:int = 0;
            var _loc_5:* = input.length;
            do
            {
                
                _loc_3 = input.indexOf("\\", _loc_4);
                if (_loc_3 >= 0)
                {
                    _loc_2 = _loc_2 + input.substr(_loc_4, _loc_3 - _loc_4);
                    _loc_4 = _loc_3 + 2;
                    _loc_6 = _loc_3 + 1;
                    _loc_7 = input.charAt(_loc_6);
                    switch(_loc_7)
                    {
                        case "\"":
                        {
                ...
                _loc_2 = _loc_2 + input.substr(_loc_4);
                break;
            }while (_loc_4 < _loc_5)
            return _loc_2;
        }// end function
