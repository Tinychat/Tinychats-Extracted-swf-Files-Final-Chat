package mx.core
{
    ...
    public interface IEmbeddedFontRegistry
    {
        ...
        function getAssociatedModuleFactory(param1:String, param2:Boolean, param3:Boolean, param4:Object, param5:IFlexModuleFactory, param6:ISystemManager, param7 = ) : IFlexModuleFactory;
